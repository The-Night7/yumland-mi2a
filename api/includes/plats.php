...
function getPlatById($id) {
    ...
    try {
        ...
        if ($plat) {
            ...
            // Auto-réparation si la BDD est vide OU contient encore les anciens "Sans objet"
            if ($options_config === '[]' || strpos($options_config, 'Sans objet') !== false || strpos($options_config, 'si viande') !== false) {
                $fallbacks = [
                    'Formule LUNCH EXPRESS' => '[{"titre":"Plat","choix":["Burger Le Grand Miam","Le Pavé du Chef","Veggie Grill"]},{"titre":"Cuisson","condition":{"Plat":["Burger Le Grand Miam","Le Pavé du Chef"]},"choix":["Saignant","À point","Bien cuit"]},{"titre":"Préparation","condition":{"Plat":["Burger Le Grand Miam","Le Pavé du Chef"]},"choix":["Standard","Viande Halal"]},{"titre":"Boisson","choix":["Coca-Cola (33cl)","Coca Zéro (33cl)","Fanta (33cl)","Sprite (33cl)","Ice Tea (33cl)","Verre de vin (12cl)","Café"]}]',
                    'Menu LITTLE COWBOY' => '[{"titre":"Plat","choix":["Mini Cheeseburger","Nuggets de Poulet"]},{"titre":"Viande","condition":{"Plat":["Mini Cheeseburger"]},"choix":["Standard","Halal"]},{"titre":"Accompagnement","choix":["Frites","Haricots verts"]},{"titre":"Dessert","choix":["Sundae Vanille Chocolat","Sundae Vanille Fraise","Compote de fruits"]},{"titre":"Boisson","choix":["Sirop à l\'eau","Jus de pomme"]}]',
                    'Menu GRILL MASTER' => '[{"titre":"Entrée","choix":["Onion Rings","Os à Moelle","Œuf Mayo"]},{"titre":"Plat","choix":["Burger Le Grand Miam","Burger Cheesy Tower","Burger Montagnard","Burger Frenchy","BBQ Ribs","Magret de Canard","Le Pavé du Chef","Pavé de Saumon"]},{"titre":"Cuisson","condition":{"Plat":["Burger Le Grand Miam","Burger Cheesy Tower","Burger Montagnard","Burger Frenchy","Le Pavé du Chef","Magret de Canard"]},"choix":["Bleu","Saignant","À point","Bien cuit"]},{"titre":"Préparation","condition":{"Plat":["Burger Le Grand Miam","Burger Cheesy Tower","Burger Montagnard","Burger Frenchy","Le Pavé du Chef"]},"choix":["Standard","Viande Halal"]},{"titre":"Dessert","choix":["Cheesecake","Brioche Perdue","Coupe de Glace 3 boules"]},{"titre":"Boisson","choix":["Pinte de Bière","Coca-Cola (50cl)","Coca Zéro (50cl)","Fanta (50cl)","Sprite (50cl)","Ice Tea (50cl)"]}]',
