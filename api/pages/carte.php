...
<main class="menu-container">
    ...
    <table class="menu-table" data-category="viandes">
        ...
        <tfoot>
        <tr>
            <td colspan="3">Toutes nos viandes sont servies avec frites à volonté et sauce au choix.</td>
        ...
        document.querySelectorAll('.menu-table').forEach(table => {
            ...
            table.querySelectorAll('tbody tr').forEach(row => {
                ...
                if (searchMatch && specMatch) {
                    row.style.display = '';
                    // If the category filter is active, this row might make the table visible
            ...
            if (selectedCategory === 'all') {
                // If showing all categories, visibility depends on whether it has rows that match other filters
                table.style.display = tableHasVisibleRows ? '' : 'none';
            } else {
                // If a specific category is chosen, hide or show the whole table
