...
<main class="legal-page">
    ...
    <aside class="legal-nav">
        ...
        <ul>
            ...
            <li><a href="#cgu">2. Conditions d'Utilisation (CGU)</a></li>
            <li><a href="#cgv">3. Conditions de Vente (CGV)</a></li>
            <li><a href="#privacy">4. Données Personnelles</a></li>
        </ul>
    </aside>

    <section class="legal-content">
        <h1>Informations Juridiques</h1>
        <p>Dernière mise à jour : 28 Janvier 2026</p>
        ...
        <article id="legal">
            ...
            <p><strong>Hébergeur :</strong><br>
                Le site est hébergé par <strong>GitHub Pages</strong>.<br>
                GitHub Inc.<br>
        ...
        <article id="cgu">
            ...
            <h3>2.3 Propriété Intellectuelle</h3>
